...
### Organize the data
#====================
bryophyteNoScaleX <- bryophytes
bryophytes <- as.HMSCdata(Y=bryophytes$Y, X = bryophytes$X, Tr = bryophytes$Tr, Phylo = bryophytes$Phylo, Random = bryophytes$Random, scaleX = TRUE, scaleTr = FALSE, interceptX = FALSE, interceptTr = FALSE)

#==============
### Build model
#==============
model<-hmsc(bryophytes,family="probit",niter=1000,nburn=100,thin=10)
